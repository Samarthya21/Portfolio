...
export default function Front(){
    ...
    <div className="p-24">
        ...
        <h1 className={`p-10 text-5xl ${inter.className}`}>Educational Qualifications</h1>
        </div>
        <div className="p-4 flex flex-row items-center gap-x-32">
        <Card title="Matric" name="CityMontessori School, Lucknow" i="https://cmseducation.org/campuses/kanpurrd/images/slider/1.jpg"></Card>
    ...
    <div className="flex flex-col items-center p-24">
        <div><h1 className="text-5xl text-bold p-10 ">Progamming Languages</h1></div>
